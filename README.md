...
- `ENTRA_CLIENT_SECRET` (app registration client secret for the dashboard; production should use a Key Vault reference)
- `ENTRA_CLIENT_SECRET_KEYVAULT_SECRET_URI` (GitHub repository variable with the Key Vault secret URI for the production Entra client secret)
